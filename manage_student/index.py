...
def input_scores():
    classes = score.get_classes()
    subjects = score.get_subjects()
...
#
#                 print(
#                     f"Student ID: {student_id}, 15 min scores: {score_15_min}, 1 hour scores: {score_1_hour}, Final exam: {final_exam}")
#
...
#                     average_score = (
#                                                 total_score_15_min + total_score_1_hour + final_exam_score * 3) / total_weight if total_weight else 0
#
#                     # Lưu điểm vào cơ sở dữ liệu
#                     score.save_student_scores(student_id, score_15_min, score_1_hour, final_exam, subject_id, semester_id,
#                                             year_id)
#
