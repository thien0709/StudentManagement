...
if __name__ == '__main__':
    with app.app_context():
        ...
        # acc2 = User(id=p2.id, username="staff", password=str(hashlib.md5("123".encode("utf-8")).hexdigest()), user_role=UserRole.STAFF)
        # acc3 = User(id=p3.id, username="teacher", password=str(hashlib.md5("123".encode("utf-8")).hexdigest()), user_role=UserRole.TEACHER)
